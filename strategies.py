...
def update_model_by_strategy(model, custom_tokenizer, text_list, label_list, base_model_wv, new_model_wv, chosen_strategy):
    import numpy as np
    ...
    return model, custom_tokenizer, base_model_wv, origin_keyword